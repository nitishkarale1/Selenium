...
public class sample5_HandlingOfAutosuggestions 
{
	public static void main(String[] args) 
	{
		...
		driver.findElement(By.xpath("//input[@class='gLFyf gsfi']")).sendKeys("Mumbai indians");
		...
		for(WebElement Option1:AllOptions)
		{
			...
			String expResult = "Mumbai indians team 2023";
